<?php
	...
	$position_in_work = $_POST["Postion_in_work"];
	...
	$query = "INSERT INTO customers(id, age, status, max_budget, living_area, position_in_work)
			  VALUES ('$id', '$age', '$status', $max_budget, '$living_area', '$position_in_work');";
	$query_two = "SELECT *
				  FROM customers
				  WHERE id = '$id';";
	//Run SQL query
	...
	{      
		...
		echo '<h2> Your details has inserted in successful in the system. </h2> <br />';
